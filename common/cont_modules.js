module.exports = {
  javaBasicUrl: 'http://127.0.0.1:8082',
  nodeBasicUrl: 'http://127.0.0.1:9008', // 手动补货 请求
  orderBasicUrl: 'http://127.0.0.1:3015', // 支付页面 生成订单请求 url
  imbaseurl: 'http://127.0.0.1:3015', 
  ...
  qrcodeHost:"http://127.0.0.1:3015",
  shoppingHost: "http://127.0.0.1:9008", //商品库存 host
  deskHost: "http://127.0.0.1:9010", //补货台 host
